...
export default function SearchBar() {
  return (
    <div className="my-5 bg-white text-gray-400 rounded-2xl px-3 py-4 flex items-center justify-between">
      <form className="flex space-x-3 items-center w-full">
        <FontAwesomeIcon icon={faSearch} />
        <input className=" w-full outline-none focus:outline-none" type="text" name="search" placeholder="Search in social..." />
      </form>
